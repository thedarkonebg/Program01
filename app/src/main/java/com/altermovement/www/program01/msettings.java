 ...
 * {@link msettings.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link msettings#newInstance} factory method to
 * create an instance of this fragment.
 */
public class msettings extends Fragment {
     ...
     * @return A new instance of fragment msettings.
     */
    // TODO: Rename and change types and number of parameters
    public static msettings newInstance(String param1, String param2) {
        msettings fragment = new msettings();
        ...
        if (getArguments() != null) {
            ...
            if (prefs.getLong("firstRun", -1) == -1) {
                ...
                try {
                    ...
                    NMJConfig.edit(getContext(), true);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.midi_settings, container, false);
        return root;
    }
